...
class Shortcode {
	...
	private function __construct() {
		...
		add_shortcode( 'nrmwprot-main-form', array( $this, 'shortcode' ) );
	}
	...
	public function shortcode( $atts ) {
		...
		$object_name = 'nrmwprot_object_' . uniqid();
		...
		$shortcode = '<div class="nrmwprot-shortcode" data-object-id="' . $object_name . '"></div>';
		return $shortcode;
	}
}
